...
select c.id, demo.title, demo.exam_date, demo.max_points
from (
    values
        ('CLS_5A', 'ENGLISH', 2026, 'FULL_YEAR', '1. Klausur', date '2026-09-22', 40),
        ('CLS_5A', 'ENGLISH', 2026, 'FULL_YEAR', '2. Klausur', date '2026-12-08', 40),
        ('CLS_5A', 'SPANISH', 2026, 'FULL_YEAR', '1. Klausur', date '2026-09-29', 40),
        ('CLS_6A', 'ENGLISH', 2026, 'FULL_YEAR', '1. Klausur', date '2026-10-06', 50),
        ('CLS_EF', 'ENGLISH', 2026, 'FULL_YEAR', '1. Klausur', date '2026-09-24', 100)
) demo(school_class, subject, calendar_year, course_period, title, exam_date, max_points)
join course c

...
import de.westarps.topteacher.mcp.CoursePupilAssignmentMcpTools;
import de.westarps.topteacher.mcp.CoursePupilAssignmentWriter;
...
import de.westarps.topteacher.mcp.PupilMcpTools;
import de.westarps.topteacher.mcp.PupilResultMcpTools;
import de.westarps.topteacher.mcp.PupilRosterConflictResolver;
import de.westarps.topteacher.mcp.PupilUpdateConflictResolver;
import de.westarps.topteacher.mcp.PupilWriter;
...
class TopTeacherApplicationTests {
	...
	void contextLoads() {
		...
		assertThat(context.getBeansOfType(CoursePupilAssignmentMcpTools.class)).isEmpty();
		assertThat(context.getBeansOfType(CoursePupilAssignmentWriter.class)).isEmpty();
		...
		assertThat(context.getBeansOfType(PupilMcpTools.class)).isEmpty();
		assertThat(context.getBeansOfType(PupilUpdateConflictResolver.class)).isEmpty();
		assertThat(context.getBeansOfType(PupilWriter.class)).isEmpty();

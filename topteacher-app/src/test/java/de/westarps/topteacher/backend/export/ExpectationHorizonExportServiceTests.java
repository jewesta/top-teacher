...
@SpringBootTest
@Sql("/demo-data.sql")
class ExpectationHorizonExportServiceTests {

	@Autowired
	private ExpectationHorizonExportService exportService;

	@Autowired
	private ExpectationHorizonExportController exportController;
	...
	@Test
	void rendersReviewedDemoExpectationHorizonAsPupilHtml() {
	...
	@Test
	void rendersReviewedDemoExpectationHorizonAsA4LandscapePdf() throws IOException {
		final DemoSelection demo = findReviewedDemoSelection();
	...
	@Test
	void exportsReviewedDemoExpectationHorizonThroughDownloadController() {
		final DemoSelection demo = findReviewedDemoSelection();

		final ResponseEntity<byte[]> response =
				exportController.exportPupilExpectationHorizon(demo.exam().id(), demo.pupil().id());
